...
"""
    ...
    一些判断：
        ...
        字符串内容判断：
            ...
            - 判断字符串是否包含指定子字符串
                   - in         子字符串 in 原始字符串            判断子字符串是否存在于原始字符串
                   - not in    子字符串 not in  原始字符串       判断子字符串是否不存在于原始字符串
    ...
    字符串总结：
        ...
        字符串判断：
            ...
            7. in         子字符串 in 原始字符串            判断子字符串是否存在于原始字符串
            8. not in    子字符串 not in  原始字符串       判断子字符串是否不存在于原始字符串
